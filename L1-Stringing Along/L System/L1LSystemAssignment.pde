...
void draw() {
  ...
  // [DONE]: Iterate (simulate) the LSystem for numIterations 
...
void keyPressed() {
  switch (key) {
    //here is where I can innit my other l Systems 
     case '1':
       lSys = initLsysOne();
       println("new l system ONE initialized");
       redraw();
       break; 
     case '2':
       lSys = initLsysTwo();
       println("new l system TWO initialized");
       redraw();
       break; 
     case '3':
       lSys = initLsysThree();
       println("new l system THREE initialized");
       redraw();
       break; 
     case 'n':
